                                ...
                                <el-row :gutter="20">
                                    <el-col :span="8">
                                        <el-form-item label="SETTING ID">
                                            <el-input v-model="formInline.user" placeholder="HOST_NAME" clearable
                                                style="width: 100%" />
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-form-item label="名称">
                                            <el-input v-model="formInline.name" placeholder="主机名" clearable
                                                style="width: 100%" />
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                ...
                                <el-row :gutter="20">
                                    <el-col :span="24">
                                        <el-form-item label="描述">
                                            <el-input v-model="formInline.description" placeholder="主机名" clearable
                                                style="width: 100%" />
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                ...
                                <el-row :gutter="20">
                                    <el-col :span="24">
                                        <el-form-item label="初始值">
                                            <el-input v-model="formInline.originValue" placeholder="Pantum Printer"
                                ...
                                <el-row :gutter="20">
                                    <el-col :span="24">
                                        <el-form-item label="校验规则">
                                            <el-input v-model="formInline.checkRules" placeholder="[A_Z] [A-Z_0-9]"
                                                clearable style="width: 100%" />
                                        </el-form-item>
                                    </el-col>
                                </el-row>
